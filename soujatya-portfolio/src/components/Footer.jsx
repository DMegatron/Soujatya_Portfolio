...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900 text-white py-8 sm:py-12 lg:py-16 border-t border-gray-800 w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12">
            ...
            <div className="text-center">
              ...
              <div className="space-y-2">
                ...
                <a href="#experience" className="block text-gray-300 hover:text-blue-400 transition-colors duration-300">
                  Experience
                </a>
                <a href="#projects" className="block text-gray-300 hover:text-blue-400 transition-colors duration-300">
                  Projects
                </a>
                <a href="#skills" className="block text-gray-300 hover:text-blue-400 transition-colors duration-300">
                  Skills
                </a>
