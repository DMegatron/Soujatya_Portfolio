...
const Projects = () => {
  ...
  const ProjectCard = ({ project }) => (
    <div className="bg-white/80 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:shadow-lg dark:hover:shadow-gray-900/50 transition-all duration-300 p-6 h-full flex flex-col backdrop-blur-sm">
      {/* Header */}
      <div className="flex items-start justify-between mb-4">
        <h3 className="text-xl font-bold text-gray-800 dark:text-white flex-1 pr-2">{project.title}</h3>
        {project.status && (
          <span className="bg-yellow-100 dark:bg-yellow-900/50 text-yellow-700 dark:text-yellow-300 px-3 py-1 rounded-full text-xs font-medium whitespace-nowrap">
            {project.status}
          </span>
        )}
      </div>
  ...
  return (
    <section id="projects" className="py-8 bg-slate-50 dark:bg-gray-900 w-full scroll-mt-20 transition-colors duration-300">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-12">
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="inline-flex items-center bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 dark:from-blue-500 dark:to-purple-500 dark:hover:from-blue-600 dark:hover:to-purple-600 text-white px-8 py-3 rounded-full hover:shadow-lg transition-all duration-300 font-medium"
            >
              <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
